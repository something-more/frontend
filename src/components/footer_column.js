    ...
    <div className="footer-content-1">
      <div className="inner-content">
        ...
        <p className="no-margin-bottom">
          <strong>phone:</strong> <a className="text-underline" href="tel:8135551234">813.555.1234</a>
          <br/>
          <strong>fax:</strong> 813.555.1235
          <br/>
    ...
    <div className="footer-content-2">
      <div className="inner-content">
        ...
        <ul className="article-list">
          ...
          <li><a href="your-link-goes-here.html">We have revolutionized the conceptualization of structuring</a>
          </li>
